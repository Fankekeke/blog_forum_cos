  ...
  computed: {
    ...
    columns () {
      return [{
        ...
        customRender: (text, record, index) => {
          ...
          return <a-popover>
            <template slot="content">
              <a-avatar shape="square" size={132} icon="user" src={ record.images } />
            </template>
            <a-avatar shape="square" icon="user" src={ record.images } />
          </a-popover>
        }
      }, {
        title: '用户编号',
        ...
        title: '头像',
        dataIndex: 'collectImages',
        customRender: (text, record, index) => {
          if (!record.collectImages) return <a-avatar shape="square" icon="user" />
          return <a-popover>
            <template slot="content">
              <a-avatar shape="square" size={132} icon="user" src={ record.collectImages } />
            </template>
            <a-avatar shape="square" icon="user" src={ record.collectImages } />
          </a-popover>
        }
      }, {
        title: '关注时间',
